...
#
#     def intersects(self, obj):
#         return abs(self.center_x - obj.center_x) < OBJECT_SIZE and abs(self.center_y - obj.center_y) < OBJECT_SIZE
#
#     def draw(self):
...
#             arcade.draw_rectangle_filled(self.center_x, self.center_y, OBJECT_SIZE, OBJECT_SIZE, arcade.color.ORANGE)
#         elif self.object_type == "pear":
#             arcade.draw_ellipse_filled(self.center_x, self.center_y, OBJECT_SIZE, OBJECT_SIZE * 1.5, arcade.color.GREEN)
#
#         if self.area is not None:
#             arcade.draw_rectangle_outline(self.area.center_x, self.area.center_y, OBJECT_SIZE * 2, OBJECT_SIZE * 2, arcade.color.BLUE)
#
...
#         all_in_areas = all(obj.area is not None and obj.intersects(obj.area) for obj in self.object_list)
#         if all_in_areas:
#             arcade.close_window()
#
...
class Object:
    ...
    def draw(self):
        if self.object_type == "apple":
            arcade.draw_circle_filled(self.center_x, self.center_y, OBJECT_SIZE, arcade.color.RED)
            arcade.draw_circle_outline(self.area.center_x, self.area.center_y, OBJECT_SIZE, arcade.color.RED)
        elif self.object_type == "banana":
            arcade.draw_rectangle_filled(self.center_x, self.center_y, OBJECT_SIZE * 2, OBJECT_SIZE, arcade.color.YELLOW)
            arcade.draw_rectangle_outline(self.area.center_x, self.area.center_y, OBJECT_SIZE * 2, OBJECT_SIZE, arcade.color.YELLOW)
        elif self.object_type == "orange":
            arcade.draw_rectangle_filled(self.center_x, self.center_y, OBJECT_SIZE, OBJECT_SIZE, arcade.color.ORANGE)
            arcade.draw_rectangle_outline(self.area.center_x, self.area.center_y, OBJECT_SIZE, OBJECT_SIZE, arcade.color.ORANGE)
        elif self.object_type == "pear":
            arcade.draw_ellipse_filled(self.center_x, self.center_y, OBJECT_SIZE, OBJECT_SIZE * 1.5, arcade.color.GREEN)
            arcade.draw_ellipse_outline(self.area.center_x, self.area.center_y, OBJECT_SIZE, OBJECT_SIZE * 1.5, arcade.color.GREEN)
