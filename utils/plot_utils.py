...
def plot_predictions(dataloader: torch.utils.data.DataLoader, model: torch.nn.Module, title: Optional[str] = None,
                     plot_all: bool = False, save_path: Optional[str] = None):
