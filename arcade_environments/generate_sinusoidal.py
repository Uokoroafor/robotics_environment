...
function_include_text_template = 'y = {func_name}(x). The value of x is {x}. What is the value of y? Ans: {y}'
...
for func, func_name in zip(func_list, func_names):
    ...
    for x, y in train_data:
        function_include_text.append(function_include_text_template.format(func_name=func_name, x=x, y=y))
